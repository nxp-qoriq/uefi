...
/* DDR4 fixed timing for LS1046ARDB */
#define CONFIG_CS0_BNDS                0x000001FF /* 0x000 */
#define CONFIG_DDR_SDRAM_CLK_CNTL      0x02000000 /* 0x130 */
#define CONFIG_CS0_CONFIG              0x80040322 /* 0x080 */
#define CONFIG_TIMING_CFG_3            0x02101100
#define CONFIG_TIMING_CFG_0            0xd1770018
#define CONFIG_TIMING_CFG_1            0xf2fc9043
#define CONFIG_TIMING_CFG_2            0x00590197
#define CONFIG_TIMING_CFG_4            0x00000002
#define CONFIG_TIMING_CFG_5            0x05401400
#define CONFIG_TIMING_CFG_7            0x26600000
#define CONFIG_TIMING_CFG_8            0x05226800
#define CONFIG_DDR_ZQ_CNTL             0x8a090705
#define CONFIG_DDR_SDRAM_MODE          0x03010630
#define CONFIG_DDR_SDRAM_MODE_3        0x00010630
#define CONFIG_DDR_SDRAM_MODE_5        0x00010630
#define CONFIG_DDR_SDRAM_MODE_7        0x00010630
#define CONFIG_DDR_SDRAM_MODE_9        0x00000500
#define CONFIG_DDR_SDRAM_MODE_10       0x08400000
#define CONFIG_DDR_SDRAM_MODE_11       0x00000400
#define CONFIG_DDR_SDRAM_MODE_12       0x08400000
#define CONFIG_DDR_SDRAM_MODE_13       0x00000400
#define CONFIG_DDR_SDRAM_MODE_14       0x08400000
#define CONFIG_DDR_SDRAM_MODE_15       0x00000400
#define CONFIG_DDR_SDRAM_MODE_16       0x08400000
#define CONFIG_DDR_SDRAM_INTERVAL      0x1ffe0000
#define CONFIG_DDR_INIT_DATA           0xdeadbeef
#define CONFIG_DDR_WRLVL_CNTL_2        0x0a0b0c10
#define CONFIG_DDRCDR_1                0x80040000
#define CONFIG_DDR_SDRAM_CFG_2         0x00401111
#define CONFIG_DDRCDR_2                0x000000c1
#define CONFIG_DDR_SDRAM_CFG           0xe5044000
