/** SoCLib.h
*  Header defining the LS1046a SoC specific constants (Base addresses, sizes, flags)
*
...
#ifndef __LS1046A_SOC_H__
#define __LS1046A_SOC_H__
...
#define FMAN_V3
#define NUM_FMAN			1
#define NUM_FMAN1_DTSEC		8
#define NUM_FMAN1_10GEC		2
