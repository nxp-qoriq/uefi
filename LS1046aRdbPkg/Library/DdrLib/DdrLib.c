  ...
  )
{
  ...
  MmioWriteBe32((UINTN)&Ddr->Cs1Bnds, CONFIG_CS0_BNDS);

  MmioWriteBe32((UINTN)&Ddr->Cs1Config, 0x80000322); 
  MmioWriteBe32((UINTN)&Ddr->Cs1Config2, 0);
  
  MmioWriteBe32((UINTN)&Ddr->Cs2Bnds, 0);
  MmioWriteBe32((UINTN)&Ddr->Cs2Config, 0); 

  MmioWriteBe32((UINTN)&Ddr->Cs2Config2, 0);
  MmioWriteBe32((UINTN)&Ddr->Cs3Bnds, 0);

  MmioWriteBe32((UINTN)&Ddr->Cs3Config, 0); 
  MmioWriteBe32((UINTN)&Ddr->Cs3Config2, 0);
  ...
  MmioWriteBe32((UINTN)&Ddr->TimingCfg6, 0);
  MmioWriteBe32((UINTN)&Ddr->TimingCfg7, CONFIG_TIMING_CFG_7);
  MmioWriteBe32((UINTN)&Ddr->TimingCfg8, CONFIG_TIMING_CFG_8);
  MmioWriteBe32((UINTN)0x01080254, 0);
  MmioWriteBe32((UINTN)&Ddr->DdrZqCntl, CONFIG_DDR_ZQ_CNTL);

  MmioWriteBe32((UINTN)&Ddr->DqMap0, 0x32C57554);
  MmioWriteBe32((UINTN)&Ddr->DqMap1, 0xD4BB0BD4);
  MmioWriteBe32((UINTN)&Ddr->DqMap2, 0x2EC2F554);
  MmioWriteBe32((UINTN)&Ddr->DqMap3, 0xD95D4001);

  MmioWriteBe32((UINTN)&Ddr->SdramCfg3, 0);
  MmioWriteBe32((UINTN)&Ddr->SdramMode, CONFIG_DDR_SDRAM_MODE);
  MmioWriteBe32((UINTN)&Ddr->SdramMode2, 0x00100200);

  MmioWriteBe32((UINTN)&Ddr->SdramMode3, CONFIG_DDR_SDRAM_MODE_3);
  MmioWriteBe32((UINTN)&Ddr->SdramMode4, 0x00100200);
  MmioWriteBe32((UINTN)&Ddr->SdramMode5, CONFIG_DDR_SDRAM_MODE_5);
  MmioWriteBe32((UINTN)&Ddr->SdramMode6, 0x00100200);
  MmioWriteBe32((UINTN)&Ddr->SdramMode7, CONFIG_DDR_SDRAM_MODE_7);
  MmioWriteBe32((UINTN)&Ddr->SdramMode8, 0x00100200);
  ...
  MmioWriteBe32((UINTN)&Ddr->SdramMdCntl, 0);
  ...
  MmioWriteBe32((UINTN)&Ddr->DdrWrlvlCntl, 0x8675f609);
  MmioWriteBe32((UINTN)&Ddr->DdrWrlvlCntl2, CONFIG_DDR_WRLVL_CNTL_2);
  MmioWriteBe32((UINTN)&Ddr->DdrWrlvlCntl3, 0x1213140e);

  MmioWriteBe32((UINTN)&Ddr->DdrSrCntr, 0);
  MmioWriteBe32((UINTN)&Ddr->DdrSdramRcw1, 0);
  MmioWriteBe32((UINTN)&Ddr->DdrSdramRcw2, 0);
  MmioWriteBe32((UINTN)&Ddr->DdrSdramRcw3, 0);
  MmioWriteBe32((UINTN)&Ddr->DdrSdramRcw4, 0);
  MmioWriteBe32((UINTN)&Ddr->DdrSdramRcw5, 0);
  MmioWriteBe32((UINTN)&Ddr->DdrSdramRcw6, 0);
 
  MmioWriteBe32((UINTN)&Ddr->DdrCdr1, CONFIG_DDRCDR_1);
  MmioWriteBe32((UINTN)&Ddr->SdramCfg2, CONFIG_DDR_SDRAM_CFG_2);
  MmioWriteBe32((UINTN)&Ddr->InitAddr, 0);
  MmioWriteBe32((UINTN)&Ddr->InitExtAddr, 0);
  MmioWriteBe32((UINTN)&Ddr->DdrCdr2, CONFIG_DDRCDR_2);
  MmioWriteBe32((UINTN)&Ddr->ErrIntEn, 0);

  MmioWriteBe32((UINTN)0x01080f70, 0x00600070);
  MmioWriteBe32((UINTN)0x01080f94, 0x80000000);

  MmioWriteBe32((UINTN)&Ddr->DdrCdr2, CONFIG_DDRCDR_2);
  MmioWriteBe32((UINTN)&Ddr->SdramCfg2, 0x00401101);

  MmioWriteBe32((UINTN)0x01080f64, 0x00009000);
  MmioWriteBe32((UINTN)0x01080f70, 0x006a0070);

  MmioWriteBe32((UINTN)&Ddr->SdramCfg, 0x65044000);
