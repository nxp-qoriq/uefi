  ...
  )
{
  ...
  if ((Instance->StartLba + Lba) > Instance->Media.LastBlock) {
    DEBUG ((EFI_D_ERROR, "FvbRead: ERROR - Parameter LBA %ld is beyond the last Lba (%ld).\n", Lba, Instance->Media.LastBlock));
  ...
  return NorFlashPlatformRead (Instance, Instance->StartLba + Lba, Offset, *NumBytes, Buffer);
}
  ...
  )
{
  ...
  if ((Instance->StartLba + Lba) > Instance->Media.LastBlock) {
    DEBUG ((EFI_D_ERROR, "FvbWrite: ERROR - Parameter LBA %ld is beyond the last Lba (%ld).\n", Lba, Instance->Media.LastBlock));
    return EFI_INVALID_PARAMETER;
  }
  ...
  return NorFlashPlatformWriteBuffer (Instance, Instance->StartLba + Lba, Offset, NumBytes, Buffer);
}
