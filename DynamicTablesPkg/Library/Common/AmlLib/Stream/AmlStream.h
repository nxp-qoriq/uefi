...
/** Rewind Stream of Offset bytes.
  ...
  The stream current position is rewinded according to the stream direction
  (forward, backward). A stream going forward will be rewinded backward.
