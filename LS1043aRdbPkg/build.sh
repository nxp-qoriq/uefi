...
build -p "$WORKSPACE/LS1043aRdbPkg/LS1043aRdbPkg$BootSuffix" -a $ARCH -t $TARGET_TOOLS -b $1 -DBOOT_VIA_QSPI_FLASH=$BOOT_VIA_QSPI_FLASH
fi

if [[ $2 == "XIP" || $2 == "QSPI" ]]; then
	cat $WORKSPACE/Build/LS1043aRdb/$1"_"$TARGET_TOOLS/FV/LS1043ARDB_EFI.fd >> $WORKSPACE/Build/LS1043aRdb/$1"_"$TARGET_TOOLS/FV/LS1043ARDBPI_EFI.fd
	mv $WORKSPACE/Build/LS1043aRdb/$1"_"$TARGET_TOOLS/FV/LS1043ARDBPI_EFI.fd $WORKSPACE/Build/LS1043aRdb/$1"_"$TARGET_TOOLS/FV/LS1043ARDB_EFI.fd
fi

if [[ $2 == "NAND" ]]; then
$3/mkimage -n $WORKSPACE/LS1043aRdbPkg/Library/LS1043aPrePiOcram/ls1043ardb_rcw_nand.cfg -R $WORKSPACE/LS1043aRdbPkg/Library/LS1043aPrePiOcram/ls1043ardb_pbi.cfg -T pblimage -A arm -a 0x10000000 -d $WORKSPACE/Build/LS1043aRdb/$1"_"$TARGET_TOOLS/FV/LS1043ARDBPI_EFI.fd $WORKSPACE/LS1043aRdbPkg/Library/LS1043aPrePiOcram/LS1043ARDBPI_NAND_EFI.pbl
echo "PBL image created at $WORKSPACE/LS1043aRdbPkg/Library/LS1043aPrePiOcram/LS1043ARDBPI_NAND_EFI.pbl"
elif [[ $2 == "SD" ]]; then
$3/mkimage -n $WORKSPACE/LS1043aRdbPkg/Library/LS1043aPrePiOcram/ls1043ardb_rcw_sd.cfg -R $WORKSPACE/LS1043aRdbPkg/Library/LS1043aPrePiOcram/ls1043ardb_pbi.cfg -T pblimage -A arm -a 0x10000000 -d $WORKSPACE/Build/LS1043aRdb/$1"_"$TARGET_TOOLS/FV/LS1043ARDBPI_EFI.fd $WORKSPACE/LS1043aRdbPkg/Library/LS1043aPrePiOcram/LS1043ARDBPI_SD_EFI.pbl
