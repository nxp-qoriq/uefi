...
!endif
  ...
  RealTimeClockLib|LS1043aRdbPkg/Library/Ls1043aRtcLib/Ls1043aRtcLib.inf
  Ds1307RtcLib|LS1043aRdbPkg/Library/Ds1307RtcLib/Ds1307RtcLib.inf
  Pcf85263RtcLib|LS1043aRdbPkg/Library/Pcf85263RtcLib/Pcf85263RtcLib.inf
...
!if $(BOOT_VIA_QSPI_FLASH) == TRUE
  ...
  gLS1043aRdbTokenSpaceGuid.PcdFlashReservedRegionBase64|0x040300000
!else
  gLS1043aRdbTokenSpaceGuid.PcdFlashDeviceBase64|0x060000000
  gLS1043aRdbTokenSpaceGuid.PcdFlashReservedRegionBase64|0x60300000
!endif
...
#
 ...
 # PCI PCDs
 #
  gLS1043aRdbTokenSpaceGuid.PcdKludgeMapPciMmioAsCached|FALSE
  gLS1043aRdbTokenSpaceGuid.PcdPciBusMin|0
  gLS1043aRdbTokenSpaceGuid.PcdPciBusMax|255
  gLS1043aRdbTokenSpaceGuid.PcdPciIoBase|0x00010000
  gLS1043aRdbTokenSpaceGuid.PcdPciIoSize|0x00010000      # 64k
  gLS1043aRdbTokenSpaceGuid.PcdPci1Mmio64Base|0x4040000000
  gLS1043aRdbTokenSpaceGuid.PcdPci2Mmio64Base|0x4840000000
  gLS1043aRdbTokenSpaceGuid.PcdPci3Mmio64Base|0x5040000000
  gLS1043aRdbTokenSpaceGuid.PcdPciMmio64Size|0x40000000
  gLS1043aRdbTokenSpaceGuid.PcdPci1ExpressBaseAddress|0x4000000000
  gLS1043aRdbTokenSpaceGuid.PcdPci2ExpressBaseAddress|0x4800000000
  gLS1043aRdbTokenSpaceGuid.PcdPci3ExpressBaseAddress|0x5000000000
  gLS1043aRdbTokenSpaceGuid.PcdPciDebug|FALSE
...
!endif
  ...
  gLS1043aRdbTokenSpaceGuid.PcdPpaQspiBaseAddr|0x40400000
  gLS1043aRdbTokenSpaceGuid.PcdPpaFwSize|0x200000 # (128MB)
...
!if $(BOOT_VIA_QSPI_FLASH) == TRUE
  gEmbeddedTokenSpaceGuid.PcdFdtDevicePaths|L"MemoryMapped(0x0,0x40F00000 ,0x40FFFFFF)/fsl-ls1043a-rdb.dtb"
!else
  gEmbeddedTokenSpaceGuid.PcdFdtDevicePaths|L"MemoryMapped(0x0,0x60F00000,0x60FFFFFF)/fsl-ls1043a-rdb.dtb"
!endif
