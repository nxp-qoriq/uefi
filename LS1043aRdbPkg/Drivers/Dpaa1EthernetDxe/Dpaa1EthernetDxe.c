  ...
  )
{
  ...
  */
  Dpaa1DiscoverFmanMemac(FM1_DTSEC_3, PHY_INTERFACE_RGMII_TXID, &gDpaa1Driver.MemacsList);
  Dpaa1DiscoverFmanMemac(FM1_DTSEC_4, PHY_INTERFACE_RGMII_TXID, &gDpaa1Driver.MemacsList);
  ASSERT(!IsListEmpty(&gDpaa1Driver.MemacsList));
