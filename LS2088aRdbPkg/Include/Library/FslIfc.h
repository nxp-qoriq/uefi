...
#define NAND_BLOCK_SIZE_512K		(128*4096)
...
#define FSL_IFC_REG_BASE	0x02240000
#define FSL_IFC_NAND_BUF_BASE	0x530000000ULL
#define FSL_IFC_NOR_BUF_BASE	0x580000000ULL

#define FSL_IFC_NOR_RESERVED_REGION_BASE	0x580900000ULL
...
#define FSL_IFC_NAND_BASE		0x530000000ULL
#define FSL_IFC_NAND_BASE_PHYS		0x30000000
/* board-specific NAND timing */
#define FSL_IFC_NAND_CSPR      (IFC_CSPR_PHYS_ADDR(FSL_IFC_NAND_BASE_PHYS) \
                                | IFC_CSPR_PORT_SIZE_8 \
                                | IFC_CSPR_MSEL_NAND \
                                | IFC_CSPR_V)
#define FSL_IFC_NAND_CSPR_EXT   0x0
#define FSL_IFC_NAND_AMASK      FSL_IFC_AMASK_BITS(64*1024)
#define FSL_IFC_NAND_CSOR       (IFC_CSOR_NAND_ECC_ENC_EN  /* ECC on encode */  \
                                ...
                                | IFC_CSOR_NAND_PB(7))  /* 2^7=128 Pages Per Block */
...
#define FSL_IFC_NAND_FTIM0      (FSL_IFC_FTIM0_NAND_TCCST(0x0e) | \
                                 FSL_IFC_FTIM0_NAND_TWP(0x30)   | \
                                 FSL_IFC_FTIM0_NAND_TWCHT(0x0e) | \
                                 FSL_IFC_FTIM0_NAND_TWH(0x14))
#define FSL_IFC_NAND_FTIM1      (FSL_IFC_FTIM1_NAND_TADLE(0x64) | \
                                 FSL_IFC_FTIM1_NAND_TWBE(0xab)  | \
                                 FSL_IFC_FTIM1_NAND_TRR(0x1c)   | \
                                 FSL_IFC_FTIM1_NAND_TRP(0x30))
#define FSL_IFC_NAND_FTIM2      (FSL_IFC_FTIM2_NAND_TRAD(0x1e) | \
                                 FSL_IFC_FTIM2_NAND_TREH(0x14) | \
                                 FSL_IFC_FTIM2_NAND_TWHRE(0x3c))
#define FSL_IFC_NAND_FTIM3       0x0
...
#define FSL_IFC_AMASK_BITS(n)		(FSL_IFC_AMASK_MASK << \
					(__ilog2(n) - FSL_IFC_AMASK_SHIFT))

/* board-specific NOR timing */
#define FSL_IFC_FLASH_BASE		0x580000000ULL
#define FSL_IFC_FLASH_BASE_PHYS		0x80000000
#define FSL_IFC_FLASH_BASE_PHYS_EARLY	0x00000000

#define FSL_IFC_NOR_AMASK		FSL_IFC_AMASK_BITS(128*1024*1024)
#define FSL_IFC_NOR_AMASK_EARLY		FSL_IFC_AMASK_BITS(64*1024*1024)
#define FSL_IFC_NOR_CSPR	(IFC_CSPR_PHYS_ADDR(FSL_IFC_FLASH_BASE_PHYS) \
				| IFC_CSPR_PORT_SIZE_16 \
				| IFC_CSPR_MSEL_NOR     \
				| IFC_CSPR_V)
#define FSL_IFC_NOR_CSPR_EARLY	(IFC_CSPR_PHYS_ADDR(FSL_IFC_FLASH_BASE_PHYS_EARLY) \
				| IFC_CSPR_PORT_SIZE_16 \
				| IFC_CSPR_MSEL_NOR     \
				| IFC_CSPR_V)
...
#define FSL_IFC_NOR_CSOR	IFC_CSOR_NOR_ADM_SHIFT(12)
#define FSL_IFC_NOR_FTIM0	(FSL_IFC_FTIM0_NOR_TACSE(0x4) | \
				 FSL_IFC_FTIM0_NOR_TEADC(0x5) | \
				 FSL_IFC_FTIM0_NOR_TEAHC(0x5))
#define FSL_IFC_NOR_FTIM1	(FSL_IFC_FTIM1_NOR_TACO(0x35) | \
				 FSL_IFC_FTIM1_NOR_TRAD_NOR(0x1a) | \
				FSL_IFC_FTIM1_NOR_TSEQRAD_NOR(0x13))
#define FSL_IFC_NOR_FTIM2	(FSL_IFC_FTIM2_NOR_TCS(0x4) | \
				 FSL_IFC_FTIM2_NOR_TCH(0x4) | \
				 FSL_IFC_FTIM2_NOR_TWPH(0xe) | \
				 FSL_IFC_FTIM2_NOR_TWP(0x1c))
#define FSL_IFC_NOR_FTIM3	0x04000000
#define FSL_IFC_NOR_CCR		0x01000000

#define FSL_IFC_NOR_CSPR0_EARLY		FSL_IFC_NOR_CSPR_EARLY
...
/* board-specific Qixis timing */
#define IFC_CSPR_PHYS_ADDR(x)	(((UINTN)x) & 0xffff0000)
#define FSL_IFC_QIXIS_CSPR_EXT	0x0
#define FSL_IFC_QIXIS_CSPR_EARLY (IFC_CSPR_PHYS_ADDR(QIXIS_BASE_PHYS_EARLY) | \
				 IFC_CSPR_PORT_SIZE_8 | \
				 IFC_CSPR_MSEL_GPCM | \
				 IFC_CSPR_V)
#define FSL_IFC_QIXIS_CSPR_FINAL (IFC_CSPR_PHYS_ADDR(QIXIS_BASE_PHYS) | \
				  IFC_CSPR_PORT_SIZE_8 | \
				  IFC_CSPR_MSEL_GPCM | \
				  IFC_CSPR_V)
#define FSL_IFC_QIXIS_AMASK	FSL_IFC_AMASK_BITS(64 * 1024)
#define FSL_IFC_QIXIS_CSOR	IFC_CSOR_NOR_ADM_SHIFT(12)

#define FSL_IFC_QIXIS_FTIM0	(FSL_IFC_FTIM0_GPCM_TACSE(0xe) | \
				FSL_IFC_FTIM0_GPCM_TEADC(0xe) | \
				FSL_IFC_FTIM0_GPCM_TEAHC(0xe))
#define FSL_IFC_QIXIS_FTIM1	(FSL_IFC_FTIM1_GPCM_TACO(0xff) | \
				FSL_IFC_FTIM1_GPCM_TRAD(0x3f))
#define FSL_IFC_QIXIS_FTIM2	(FSL_IFC_FTIM2_GPCM_TCS(0xf) | \
				FSL_IFC_FTIM2_GPCM_TCH(0xf) | \
				FSL_IFC_FTIM2_GPCM_TWP(0x3e))
#define FSL_IFC_QIXIS_FTIM3	0x0

#define FSL_IFC_QIXIS_CSPR 	FSL_IFC_QIXIS_CSPR_FINAL
