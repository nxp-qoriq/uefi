...
#define BUS_DSPI1	 	1
#define DSPI_FLASH_BAR

#define DEFAULT_SPEED 	30000000
#define DEFAULT_MODE 	SPI_COMMON_MODE_3
#define DEFAULT_CS 		0
#define DEFAULT_BUS 		1

/* tx/rx data wait timeout in us */
#define DSPI_XFER_WAIT_TIMEOUT     1000000

/* max chipselect signals number */
#define DSPI_MAX_CHIPSELECT        6

/* Status */
#define DSPI_STR_TCF                0x80000000
#define DSPI_STR_TXRXS              0x40000000
#define DSPI_STR_EOQF               0x10000000
#define DSPI_STR_TFUF               0x08000000
#define DSPI_STR_TFFF               0x02000000
#define DSPI_STR_RFOF               0x00080000
#define DSPI_STR_RFDF               0x00020000
#define DSPI_STR_TXCTR(X)           (((X) & 0x0000F000) >> 12)
#define DSPI_STR_TXPTR(X)           (((X) & 0x00000F00) >> 8)
#define DSPI_STR_RXCTR(X)           (((X) & 0x000000F0) >> 4)
#define DSPI_STR_RXPTR(X)           ((X) & 0x0000000F)
...
#define DSPI_TXR_PCS(X)     (((1 << X) & 0x0000003f) << 16)
#define DSPI_TXR_CONT 	(0x80000000)
#define DSPI_TXR_CTAS(X)	(((X)&0x07)<<12)
#define DSPI_TXR_EOQ		(0x08000000)
#define DSPI_TXR_CTCNT	(0x04000000)
#define DSPI_TXR_CS7		(0x00800000)
#define DSPI_TXR_CS6		(0x00400000)
#define DSPI_TXR_CS5		(0x00200000)
#define DSPI_TXR_CS4		(0x00100000)
#define DSPI_TXR_CS3		(0x00080000)
#define DSPI_TXR_CS2		(0x00040000)
#define DSPI_TXR_CS1		(0x00020000)
#define DSPI_TXR_CS0		(0x00010000)

/* Module Configuration */
#define DSPI_MC_MSTR		(0x80000000)
#define DSPI_MC_PCSIS(X)    (1 << (16 + (X)))
#define DSPI_MC_PCSIS_MASK  (0xff << 16)
...
#define DSPI_CTR0 			(DSPI_CTR_TRSZ(7) | DSPI_CTR_PCSSCK_1CLK |\
					DSPI_CTR_PASC(0) | DSPI_CTR_PDT(0) | \
					DSPI_CTR_CSSCK(0) | DSPI_CTR_ASC(0) | \
					DSPI_CTR_DT(0))

/* CTAR register pre-configure mask */
#define DSPI_CTR_SET_MODE_MASK     (DSPI_CTR_TRSZ(15) | \
                                   DSPI_CTR_PCSSCK(3) | \
                                   DSPI_CTR_PASC(3) | \
                                   DSPI_CTR_PDT(3) | \
                                   DSPI_CTR_CSSCK(15) | \
