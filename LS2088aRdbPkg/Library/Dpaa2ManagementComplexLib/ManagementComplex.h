...
#define DPAA2_MC_PORTAL_ADDR(_portal_id) \
	((EFI_PHYSICAL_ADDRESS)DPAA2_MC_PORTALS_BASE_ADDR + \
	 (_portal_id) * DPAA2_MC_PORTAL_STRIDE)

#define MC_PORTAL_OFFSET_TO_PORTAL_ID(_portal_offset) \
	((_portal_offset) / DPAA2_MC_PORTAL_STRIDE)
