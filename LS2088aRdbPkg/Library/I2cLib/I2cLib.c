  ...
  )
{
  ...
  ClkRate = (SocSysInfo.FreqSystemBus / 2);
...
{
  struct I2cRegs *I2cRegs = (VOID *)I2C1_BASE_ADDRESS;
  ...
  )
{
  ...
  InternalMemZeroMem(Buffer, sizeof(Buffer));
  ...
  )
{
  ...
  switch (I2c) {
	...
	break;
    case I2C4:
	BaseAddress = (VOID *)I2C4_BASE_ADDRESS;
	break;
    default:
	return EFI_INVALID_PARAMETER;
  }
